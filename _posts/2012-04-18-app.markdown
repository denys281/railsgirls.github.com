...
Потрібні підказки протягом воркшопу? Подивись [cheatsheet для Ruby, Rails, console і т.п.](http://www.pragtob.info/rails-beginner-cheatsheet/)
...
**Ментор:** Розкажи про CSS та layouts.
