...
function initializeOsSwitchers() {
  $(".os-specific").append("<span class='picker'>Вибери операційну систему: <a href='#' class='win-link'>Windows</a> | <a href='#' class='nix-link'>Інша</a></span>").find(".win-link").click(function(event) {
